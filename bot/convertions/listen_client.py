...
from .utils.exceptions import ListenerStopped, ListenerTimeout
from .utils.config import config
from .utils.listener import ListenerTypes, Identifier, Listener
...
class Client(CL):
    ...
    async def ask(
        ...
        if text.strip() != "":
            ...
            sent_message = await self.send_message(chat_id=chat_to_ask, text=text, **kwargs)
